...
export function emptyChampionIdentityV1(championId: string): ChampionIdentityV1 {
  return {
    ...
    lanePhilosophy: emptyPhilosophy("laning"),
    teamfightPhilosophy: emptyPhilosophy("teamfighting"),
    sideLanePhilosophy: emptyPhilosophy("map-awareness"),
    objectivePhilosophy: emptyPhilosophy("objectives"),
    waveManagementPhilosophy: emptyPhilosophy("wave-management"),
    recallPhilosophy: emptyPhilosophy("recall-timing"),
